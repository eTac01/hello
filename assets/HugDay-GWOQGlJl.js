import{l,n as p,e as g,f as d,a as r,V as m,h as a,G as v,i as c,r as f,j as w}from"./three-BDTjZVi7.js";import{g as s}from"./gsap-C8pce-KX.js";import{B as L}from"./BaseExperience-BpReppXp.js";import{C as n}from"./index-m0RpZGsX.js";class D extends L{constructor(t,e,i){super(t,e,i),this.leftLight=null,this.rightLight=null,this.embraceProgress=0}getInstruction(){return"Bring them together..."}getCompletionMessage(){return"In an embrace,<br>two become one warmth."}async init(){this.createLights(),this.createWarmthField(),this.setupInteraction(),await super.init(),this.unsubscribeUpdate=this.sceneManager.onUpdate(this.update.bind(this))}createLights(){const t=(e,i)=>{const o=new v,h=new a(new c(.3,32,32),new f({color:e,transparent:!0,opacity:.9}));o.add(h);const u=new a(new c(.5,32,32),new g({uniforms:{uColor:{value:new r(e)},uTime:{value:0}},vertexShader:`
