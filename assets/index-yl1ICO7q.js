const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RoseDay-BJmuikU3.js","assets/three-BDTjZVi7.js","assets/gsap-C8pce-KX.js","assets/BaseExperience-D8fMzVIG.js","assets/ProposeDay-DgH3kcru.js","assets/ChocolateDay-BRFiuyBW.js","assets/TeddyDay-D1w9EU4w.js","assets/PromiseDay-DmqE_kzd.js","assets/HugDay-Bys9QTxf.js","assets/KissDay-Czost-Zk.js","assets/ValentineDay-w3gjeByf.js"])))=>i.map(i=>d[i]);
import{C as B,V as v,S as G,a as w,F as A,P as j,W as N,b as O,A as F,c as k,B as E,d as f,e as C,f as y,g as P,D as V,M as z,h as x,G as H,i as U,j as W,k as X,l as D,R as q,m as Y,n as $,o as S,p as Z,E as K,q as Q,T as J,r as ee,L as te,s as ie}from"./three-BDTjZVi7.js";import{g as l}from"./gsap-C8pce-KX.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();const se="modulepreload",oe=function(u){return"/hello/"+u},L={},g=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),n=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));s=Promise.allSettled(t.map(r=>{if(r=oe(r),r in L)return;L[r]=!0;const p=r.endsWith(".css"),b=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${b}`))return;const h=document.createElement("link");if(h.rel=p?"stylesheet":se,p||(h.as="script"),h.crossOrigin="",h.href=r,n&&h.setAttribute("nonce",n),document.head.appendChild(h),p)return new Promise((M,T)=>{h.addEventListener("load",M),h.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${r}`)))})}))}function o(a){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=a,window.dispatchEvent(n),!n.defaultPrevented)throw a}return s.then(a=>{for(const n of a||[])n.status==="rejected"&&o(n.reason);return e().catch(o)})},c={charcoal:1182744,roseRed:16711935,champagneGold:65535,deepPurple:2956110},d=[{date:"2026-02-07",day:"Rose Day",theme:"Admiration",emoji:"🌹",index:0,experience:"RoseDay",url:"/rose-day.html"},{date:"2026-02-08",day:"Propose Day",theme:"Confession",emoji:"💍",index:1,experience:"ProposeDay",url:"/propose-day.html"},{date:"2026-02-09",day:"Chocolate Day",theme:"Sweetness",emoji:"🍫",index:2,experience:"ChocolateDay",url:"/chocolate-day.html"},{date:"2026-02-10",day:"Teddy Day",theme:"Comfort",emoji:"🧸",index:3,experience:"TeddyDay",url:"/teddy-day.html"},{date:"2026-02-11",day:"Promise Day",theme:"Trust",emoji:"🤝",index:4,experience:"PromiseDay",url:"/promise-day.html"},{date:"2026-02-12",day:"Hug Day",theme:"Warmth",emoji:"🤗",index:5,experience:"HugDay",url:"/hug-day.html"},{date:"2026-02-13",day:"Kiss Day",theme:"Intimacy",emoji:"💋",index:6,experience:"KissDay",url:"/kiss-day.html"},{date:"2026-02-14",day:"Valentine's Day",theme:"Union",emoji:"❤️",index:7,experience:"ValentineDay",url:"/valentine-day.html"}],ae=d.map((u,e)=>{const t=e/8*Math.PI*2-Math.PI/2,i=4;return{x:Math.cos(t)*i,y:0,z:Math.sin(t)*i,angle:t}}),ne={capsuleRotationSpeed:2e-4},I={high:{particleCount:1e3,shadowMapSize:2048,antialias:!0,postProcessing:!0},medium:{particleCount:500,shadowMapSize:1024,antialias:!0,postProcessing:!0},low:{particleCount:200,shadowMapSize:512,antialias:!1,postProcessing:!1}};class re{constructor(e){this.container=e,this.width=window.innerWidth,this.height=window.innerHeight,this.qualityTier=this.detectQualityTier(),this.isRunning=!1,this.clock=new B,this.callbacks=[],this.mouse=new v,this.targetMouse=new v,this.mouseVelocity=new v,this.lastMouse=new v,this.init()}detectQualityTier(){const e="ontouchstart"in window||navigator.maxTouchPoints>0,t=document.createElement("canvas"),i=t.getContext("webgl2")||t.getContext("webgl");if(!i)return"low";const s=i.getExtension("WEBGL_debug_renderer_info");if(s){const o=i.getParameter(s.UNMASKED_RENDERER_WEBGL);if(console.log("[SceneManager] GPU:",o),o.includes("Mali")||o.includes("Adreno")||o.includes("PowerVR"))return"low";if(o.includes("Intel"))return e?"low":"medium"}if(navigator.deviceMemory){if(navigator.deviceMemory<4)return"low";if(navigator.deviceMemory<8)return"medium"}return e?"medium":"high"}init(){const e=I[this.qualityTier];this.scene=new G,this.scene.background=new w(c.charcoal),this.scene.fog=new A(c.charcoal,.08),this.camera=new j(60,this.width/this.height,.1,100),this.camera.position.set(0,2,8),this.camera.lookAt(0,0,0),this.renderer=new N({antialias:e.antialias,alpha:!1,powerPreference:"high-performance"}),this.renderer.setSize(this.width,this.height),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=O,this.renderer.toneMapping=F,this.renderer.toneMappingExposure=1.2,this.container.appendChild(this.renderer.domElement);const t=new k(16777215,.1);this.scene.add(t),this.createAmbientParticles(),this.setupEventListeners()}createAmbientParticles(){const t=I[this.qualityTier].particleCount,i=new E,s=new Float32Array(t*3),o=new Float32Array(t),a=new Float32Array(t);for(let r=0;r<t;r++)s[r*3]=(Math.random()-.5)*30,s[r*3+1]=(Math.random()-.5)*20,s[r*3+2]=(Math.random()-.5)*30,o[r]=Math.random()*2+.5,a[r]=Math.random()*.5+.1;i.setAttribute("position",new f(s,3)),i.setAttribute("size",new f(o,1)),i.setAttribute("alpha",new f(a,1));const n=new C({uniforms:{uTime:{value:0},uColor:{value:new w(c.champagneGold)},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)}},vertexShader:`
