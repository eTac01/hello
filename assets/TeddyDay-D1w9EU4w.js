import{B as M,a as m,d as u,e as f,f as d,g as x,i as b,h as P}from"./three-BDTjZVi7.js";import{g as p}from"./gsap-C8pce-KX.js";import{B as y}from"./BaseExperience-D8fMzVIG.js";import{C as c}from"./index-yl1ICO7q.js";class L extends y{constructor(t,o,e){super(t,o,e),this.comfortLevel=0,this.maxComfort=100}getInstruction(){return"Stay close... feel the comfort"}getCompletionMessage(){return"In stillness,<br>we find each other."}async init(){this.createComfortParticles(),this.createCenterGlow(),this.setupInteraction(),await super.init(),this.unsubscribeUpdate=this.sceneManager.onUpdate(this.update.bind(this))}createComfortParticles(){const o=new M,e=new Float32Array(300*3),i=new Float32Array(300*3),s=new Float32Array(300),v=new m(c.champagneGold),C=new m(c.roseRed);for(let r=0;r<300;r++){const h=Math.random()*Math.PI*2,a=Math.random()*Math.PI,n=3+Math.random()*2;e[r*3]=n*Math.sin(a)*Math.cos(h),e[r*3+1]=n*Math.sin(a)*Math.sin(h),e[r*3+2]=n*Math.cos(a);const g=Math.random(),l=v.clone().lerp(C,g);i[r*3]=l.r,i[r*3+1]=l.g,i[r*3+2]=l.b,s[r]=Math.random()*3+1}o.setAttribute("position",new u(e,3)),o.setAttribute("color",new u(i,3)),o.setAttribute("size",new u(s,1)),this.originalPositions=e.slice();const w=new f({uniforms:{uTime:{value:0},uComfort:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)}},vertexShader:`
